...
HD_PWD='C:/Users/usuario/gcd_algo/gcd_algo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_gcd.tcl -notrace

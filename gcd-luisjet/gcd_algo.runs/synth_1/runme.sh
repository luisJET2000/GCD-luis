...
HD_PWD='C:/Users/usuario/gcd_algo/gcd_algo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_gcd.tcl
